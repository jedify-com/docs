...
- **Auto-link on create.** When a semantic dimension is created on a column, Jedify attaches it to every entity whose attributes or base query reference that same source column. No manual step required.
