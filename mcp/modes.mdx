...
On a **hosted agent or app builder** (no local proxy), select the mode in the server URL instead: `https://be.jedify.com/mcp/message?mode=editor` or `https://be.jedify.com/mcp/message?mode=builder`.
